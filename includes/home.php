...
?>
		...
		<h2>Bienvenue sur Nix, étranger !</h2>

	<h3>Mais qu'est-ce donc ?</h3>
	<p>Nix est un serveur à vocation rôliste autour d'un univers peu commun se divisant entre la politique, ainsi que des études diverse sur des choses étranges que les habitants ont nommé communément "la magie". 
	RPNix.com vous propose une aventure dans l'imaginaire collectif. Ce dernier s'adresse aux joueurs de Minecraft souhaitant parfaire leur expérience de jeu en ajoutant des éléments scénaristiques uniques ! </p>
		
	<h3>Mais concrètement, comment ça marche ?</h3>
	<p>Il vous suffit de vous inscrire et de créer votre personnage pour commencer cette grande aventure au sein de notre communauté.<br />
	A votre arrivez vous incarnez un voyageur qui après une longue marche arrive sur des terres enneigé. Votre personnage pourra donc très vite prendre contact avec les différentes personnes de Nix.  
