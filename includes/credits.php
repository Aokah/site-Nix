...
{
?>
	<h2>Remerciements divers</h2>
	<p>Ici seront répertoriées les différents noms des personnes ayant contribué plus ou moins à Nix.</p>
	
	<table cellspacing="0" cellpadding="5" width="80%" align="center" style="border: 5px gray solid; border-radius: 10px; background-color: #DDDDDD;text-shadow: white 1px 1px 4px;">
		<tbody>
