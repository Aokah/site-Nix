...
{?>
	<div id="races">
	<h3>Les races</h3>
	<h4 style="clear: both;">Les Humains</h4>
	<p><a href="pics/base_Humain.png" style="float: left;" target=_blank /><img src="pics/skin_humain.gif" alt="Skin de l'Humain" title="Clique pour obtenir le skin" /></a></p>
	<p class="tab">Très généralement remortels, les humains sont des personnes constituées d'os, de muscle, d'organes et de peau. Ils vivent généralement en communauté pour mieux survivre et savent s'adapter aux intempéries. Malgré le fait qu'ils soient une même race, plusieurs peuples aux coutumes différentes existent.</p>
	
	<h4 style="clear: both;">Les Onyx</h4>
	<p><a href="pics/base_Onyx.png" style="float: left;" target=_blank /><img src="pics/skin_onyx.gif" alt="Skin de l'Onyx" title="Clique pour obtenir le skin" /></a></p>
	<p class="tab">Race très peu connues, étant donné la rareté de ces personnes qui naissent du Ciel. Les Onyx sont semblables aux humains sauf qu'au lieu d'avoir un nez, ils respirent par les pores de leur peau, qui est aussi noire que leurs yeux sont luisants. Les Onyx sont très généralement des personnes pacifiques et peu violentes, ce qui est surtout dû à leurs faible constitution, les rendant plus fragiles que des humains.</p>
	
	<h4 style="clear: both;">Les Chimères</h4>
	<p><img src="pics/skin_chimere.gif" style="float: left;"  alt="Skin de la Chimère" title="Débloquable avec Accord du Staff" /></p>
	<p class="tab">Il arrive que des mélanges improbables aient lieux. Accident runique, reste magique puissant, cobaye d’expérience, ou simplement mutation impressionnante, les chimères sont un mélange assez terrifiant de deux espèces. Les chimères humaines sont vraiment laides. De plus elles sont pas très saines d'esprit, en effet, si elle ne sont pas en communautés elles ont tendances a laisser leurs instinct primitifs prendre le dessus, et c'est alors qu'un homme avec un museau se sauvera pour chasser un cochon par ci par là. Comme n'importe quel animal, les chimères n'attaquent pas délibérément les hommes, même si l'homme est un ennemi, elle cherchera à s'en éloigner le plus possible, et attaquera SEULEMENT si elle est encerclés et que pour fuir elle ne peut faire autrement.<br/>
	<br /><span class="error">Les candidatures de Chimère sont actuellement fermées le temps de corriger le gameplay de la race.</span></p>
	...
	<p class="tab">Ces êtres sont un quart de fois plus petits que les hommes normaux. Ils sont généralement installés dans la région des Feldspaths, car les cavernes leurs ont permis de faire un tas de mine, et leur marché de forge prospère chez les autres races.</p>
