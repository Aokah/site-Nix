		 	...
		 	if ($string != "none")
		 	{
				...
				if ($line['gamedesc'] != "")
				{
			 		...
			 		switch ($radius)
			 		{
			 			...
			 			case 2 : $option = "@a[r=50]"; $color = "yellow"; break; case 3: $option = "@a[r=30]"; $color ="green"; break;
			 			case 4: $option = "@a[r=10]"; $color = "dark_green"; break; case 5: $option = "@a[r=5]"; $color ="dark_aqua"; break;
			 			case 6 : $option = "@p"; $color = "dark_gray"; break;
			 		}
					//message descriptif
